...
exports.registerValidator = [
  ...
  validator
    .check(
      "password",
      "password must be grater then 6 character and atleast one uppercase, lowercase, number and special character"
    )
    .isStrongPassword({
      minLength: 6,
      minLowercase: 1,
...
exports.loginValidator = [
  ...
  validator.check("password", "Password is required").not().isEmpty(),
];
